...
// autoloaders
// require_once 'Symfony/vendor/doctrine-common/lib/Doctrine/Common/ClassLoader.php';
...
// $classLoader = new \Doctrine\Common\ClassLoader('Entities/New', __DIR__);
// $classLoader->register();
...
$em = \Gustavus\Doctrine\EntityManager::getEntityManager('/cis/lib/Gustavus/Concert', null, 'concert');
...
$generator->generate($metadata, __DIR__ . '/GeneratedEntities/');
