...
class SharedController extends ConcourseController
{
  ...
  {
    return sprintf('Congratulations! You have successfully published %s.<br /><a href="%s" class="button blue">View Recent Activity</a>', Utility::removeDocRootFromPath($file), $this->buildUrl('recentActivity'));
  }
  ...
  protected function buildDraftSavedSuccessMessage(array $draft, $showPublicUrl = true)
  {
    ...
    return sprintf(
        'Congratulations! You have successfully saved a draft for %s. %s<br /><a href="%s" class="button blue">View Recent Activity</a>',
