tinymce.PluginManager.add("filebrowser",function(a){a.settings.origFileBrowserCallback=a.settings.file_browser_callback;a.settings.file_browser_callback=function(d,f,b,e){if("file"===b)a.windowManager.open({title:"Choose a file",url:Gustavus.Utility.URL.urlify("/concert/filebrowser/filebrowser.php",{filePath:Gustavus.Concert.filePath}),buttons:[{text:"Concert File Manager",onclick:function(){a.windowManager.close();return a.settings.origFileBrowserCallback(d,f,b,e)},icon:"browse",classes:"primary"}]},
