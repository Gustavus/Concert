...
<head>
<title>2013 Symposium</title>

<!-- CSS -->
<link rel="stylesheet" href="http://gustavus.edu/css/base.v1.css" type="text/css"
  media="screen, projection">
<link rel="stylesheet" href="http://gustavus.edu/css/contribute.css" type="text/css"
  media="screen, projection">
...
&nbsp;
<div class="nodisplay">
<!-- InstanceBeginNonEditable name="LocalNavigation" -->Local Nav Here<!-- InstanceEndNonEditable -->
</div>
...
<h1 id="page-title">
<!-- InstanceBeginEditable name="Title" -->Lindau Symposium
<!-- InstanceEndEditable -->
</h1>

<div id="page-subtitle">
<!-- InstanceBeginNonEditable name="Subtitle" --><!-- InstanceEndNonEditable -->
</div>
